...
edit(){
  ...
  if(this.state.itemSelected.length>1){
    ...
    for(a=0;a<itemsList.length;a++){
      if(itemsList[a].selected == true){
        console.log('this is key: ',itemsList[a].key,itemsList[a].date,)
        this.setState({
          editor:{
            key:itemsList[a].key,
            ...
            cardBackgroundColor:'white',
            selected:false,
            delivered:itemsList[a].delivered,
            histories:itemsList[a].histories,
...
gemachEditor(){
  let itemsList = this.state.itemsList
  itemsList[this.state.editor.itemNumber]=this.state.editor,
  this.setState({
    itemsList:itemsList,
    itemSelected:[],
